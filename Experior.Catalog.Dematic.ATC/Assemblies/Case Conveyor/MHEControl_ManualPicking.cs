...
namespace Experior.Catalog.Dematic.ATC.Assemblies.CaseConveyor
{
    ...
    {
        private ManualPickingATCInfo manualPickDatcomInfo;
        ...
        public void CallForwardReceived(string barcode)
        {
            ...
            if (caseLoad.SSCCBarcode != barcode)
            {
    ...
    [Serializable]
    [XmlInclude(typeof(ManualPickingATCInfo))]
    public class ManualPickingATCInfo : ProtocolInfo
    {
