...
namespace Experior.Dematic.Base
{
    ...
    [Serializable]
    [TypeConverter(typeof(BaseControllerInfo))]
    public class BaseControllerInfo : AssemblyInfo
    {
        public int receiverID;
        public bool LogHeartBeat;
        public string SystemIdentifier;
