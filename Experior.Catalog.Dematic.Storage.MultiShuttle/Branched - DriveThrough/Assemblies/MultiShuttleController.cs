...
namespace Experior.Catalog.Dematic.Storage.Assemblies
{
        ...
        /// </summary>
        public class MultiShuttleController : Assembly, IMultiShuttleController
        {
            ...
            public MultiShuttleController(MultiShuttleControllerInfo info)
                : base(info)
            {
                controllerinfo = info;
            ...
            private void Telegram05Recieved(string[] splittelegram, int datasets)
            {
                ...
                if (currentPosition2.Substring(0, 1) == "S")
                {
                    ...
                    if (destinationPosition2.Substring(0, 1) == "O")
                    {
                        ...
                        if (rackconv.Route.Motor.Direction == Core.Motors.Motor.Directions.Forward)
                        {
            ...
            private void SendULData()
            {
                foreach (DematicMultiShuttle multishuttle in multishuttles)
                {
                    ...
                    foreach (InfeedPickStationConveyor conv in multishuttle.PickStationConveyors)
                    {
                        ...
                        {
                            Case_Load caseload2 = conv.Location2.ActiveLoad as Case_Load;
                            ...
                            string location2 = "P" + conv.Elevator.ParentMultiShuttle.AisleNo + conv.Location2.Name.Substring(3, 2) + conv.Elevator.ParentMultiShuttle.POS2 + conv.Level;
                            ...
                            Case_Load caseload1 = conv.Location1.ActiveLoad as Case_Load;

                            if (caseload1 != null)
                            {
                                //update current position
                                string location1 = "P" + conv.Elevator.ParentMultiShuttle.AisleNo + conv.Location1.Name.Substring(3, 2) + conv.Elevator.ParentMultiShuttle.POS1 + conv.Level;
            ...
            private void SendEquipmentStatus(string status)
            {
                foreach (DematicMultiShuttle multishuttle in multishuttles)
                {
                    ...
                    {
                        string type = "O";
                        if (r.RackConveyorType == RackConveyor.RackConveyorTypes.Infeed)
                            type = "I";
                    ...
                    foreach (InfeedPickStationConveyor c in multishuttle.PickStationConveyors)
                    {
                        ...
                        string name = "P" + multishuttle.AisleNo + c.Location1.Name.Substring(3,2) + "   " + c.Level;
                    ...
                    foreach (DropStationPoint d in multishuttle.DropStationPoints.Values)
                    {
            ...
            private void Telegram01Recieved(string[] splittelegram, int datasets)
            {
                ...
                if (currentPosition2.Substring(0, 1) == "R")
                {
                    ...
                    else if (destinationPosition2.Substring(0, 1) == "R")
                    {
                        ...
                        if (destdistance > multishuttle.Raillength)
                            destdistance = multishuttle.Raillength;
                ...
                else if (currentPosition2.Substring(0, 1) == "P")
                {
                    ...
                    InfeedPickStationConveyor conv = caseload2.CurrentActionPoint.Parent.Parent as InfeedPickStationConveyor;
                    ...
                    if (elevator.ParentMultiShuttle.MixedInfeedOutfeed && destinationPosition2.Substring(0, 1) == "I")
                    {
                        ...
                        if (dest.RackConveyorType == RackConveyor.RackConveyorTypes.Outfeed)
                        {
                    ...
                    {
                        JobType = RackConveyor.RackConveyorTypes.Infeed,
                    ...
                    if (destinationPosition2.Substring(0, 1) == "D")
                    {
                        //Pick station to drop station move
                        elevatordata.JobType = RackConveyor.RackConveyorTypes.Outfeed;
                    }
                ...
                else if (currentPosition2.Substring(0, 1) == "I")
                {
                    ...
                    if (destinationPosition2.Substring(0, 1) == "R")
                    {
                        ...
                        if (destionationdistance > multishuttle.Raillength)
                            destionationdistance = multishuttle.Raillength;


                        RackConveyor rackconv = caseload2.CurrentActionPoint.Parent.Parent as RackConveyor;
                    ...
                    else if (destinationPosition2.Substring(0, 1) == "O")
                    {
                        ...
                        if (destrackconv.Route.Motor.Direction == Core.Motors.Motor.Directions.Forward)
                        {
                            LogMessage("Error. Destination rack is not outfeed rack!", Color.Red);
                            Core.Environment.Scene.Pause();
                            return;
                        ...
                        //Delete elevator job from userdata.
                        caseload2.UserData = null;

                        RackConveyor infeedrackconv = caseload2.CurrentActionPoint.Parent.Parent as RackConveyor;

                        float positionoffset = multishuttle.RackConveyorLength / 4;
                        if (infeedrackconv.LocalYaw == (float)Math.PI)
                            positionoffset = -multishuttle.RackConveyorLength / 4;
                        ...
                        if (destrackconv.LocalYaw == (float)Math.PI)
                            positionoffsetdrop = -multishuttle.RackConveyorLength / 4;
                ...
                else if (currentPosition2.Substring(0, 1) == "O")
                {
                    ...
                    if (currentPosition1.Length >= 10 && datasets == 2)
                    {
                        ...
                        if (secondpicklevel != picklevel)
                        {
                            ...
                            {
                                if (k < 5)
                                    secondsplittelegram[k] = splittelegram[k];
                                else if (k == 5)
                                    secondsplittelegram[k] = "1";
                                else
                                    secondsplittelegram[k] = splittelegram[k + 11];
                            }
                        }
                    }
                    ...
                    MultishuttleElevatorJobData elevatordata = new MultishuttleElevatorJobData()
                    {
                        JobType = RackConveyor.RackConveyorTypes.Outfeed,
                        JobMode = MultishuttleElevatorJobData.JobModes.Load1,
                    ...
                    if (destinationPosition2.Substring(0, 1) == "I")
                        elevatordata.JobType = RackConveyor.RackConveyorTypes.Infeed;
                ...
                if (job.JobType == ShuttleJob.JobTypes.Goto)
                {
                    ...
                    if (shuttlecar.Control.JobQueue.Count > 0)
                    {
                        ...
                        if (nextjob.JobType == ShuttleJob.JobTypes.Drop && !nextjob.Rack)
                        {
                            ...
                            if (conv.Location2.Active)
                            {
                                shuttlecar.Control.Stop(lockshuttle: true);
                            }
                        }
                    }
                }
            ...
            void Shuttle_LoadPicked(Shuttle shuttlecar, Load load, bool rack, string id, ShuttleJob job)
            {
                ...
                if (caseload != null)
                {
                    //Update current position to be on the shuttle
                    caseload.Case_Data.CurrentPosition = "S" + shuttlecar.Multishuttle.AisleNo + "     " + shuttlecar.Level;
                    //Remove elevator job
                    caseload.UserData = null;
                }
                if (job.JobType == ShuttleJob.JobTypes.Pick && !job.Rack)
                {
                    //Shuttle picks a tote from rack conv. Release position 1. 
            ...
            private void CheckElevator(MultiShuttleElevator elevator)
            {
                ...
                if (elevator.Location1.Active || elevator.Location2.Active)
                {
                    if (elevator.CurrentJobData.UnloadConveyor.Route.Loads.Count < 2)
                    {
                        elevator.Location2.Release();
                        elevator.Location1.Release();
            ...
            void SetElevatorConveyorDirection(MultiShuttleElevator elevator, float convX, float elevatorX, bool infeeddirection)
            {
            ...
            void Elevator_FinishedGotoJob(Shuttle shuttlecar, ShuttleJob job)
            {
                try
                {
                    ...
                    {
                        case MultishuttleElevatorJobData.JobModes.Load1:
                            if (jobdata.CaseLoadPosition2 != null && jobdata.CaseLoadPosition2.CurrentActionPoint.Parent.Parent is InfeedPickStationConveyor)
                            {
                                InfeedPickStationConveyor conv = jobdata.CaseLoadPosition2.CurrentActionPoint.Parent.Parent as InfeedPickStationConveyor;
                                SetElevatorConveyorDirection(elevator, conv.LocalPosition.X, elevator.LocalPosition.X, true);
                                conv.Location1.Release();
                                jobdata.CaseLoadPosition2.Release();
                            }
                            else if (jobdata.CaseLoadPosition1 != null && jobdata.CaseLoadPosition1.CurrentActionPoint.Parent.Parent is RackConveyor)
                            {
                                RackConveyor conv = jobdata.CaseLoadPosition1.CurrentActionPoint.Parent.Parent as RackConveyor;
                                SetElevatorConveyorDirection(elevator, conv.LocalPosition.X, elevator.LocalPosition.X, true);
                            ...
                            {
                                LogMessage("Error Load1. Not a rack conv and not pick station conveyor!", Color.Red);
                                Core.Environment.Scene.Pause();
                                return;
                            }
                            break;
                        case MultishuttleElevatorJobData.JobModes.Load2:
                            if (jobdata.CaseLoadPosition2.CurrentActionPoint.Parent.Parent is InfeedPickStationConveyor)
                            {
                                InfeedPickStationConveyor conv = jobdata.CaseLoadPosition2.CurrentActionPoint.Parent.Parent as InfeedPickStationConveyor;
                                SetElevatorConveyorDirection(elevator, conv.LocalPosition.X, elevator.LocalPosition.X, true);
                            }
                            else if (jobdata.CaseLoadPosition1.CurrentActionPoint.Parent.Parent is RackConveyor) 
                            {
                                RackConveyor conv = jobdata.CaseLoadPosition1.CurrentActionPoint.Parent.Parent as RackConveyor;
                                SetElevatorConveyorDirection(elevator, conv.LocalPosition.X, elevator.LocalPosition.X, true);
                            }
                            ...
                            {
                                LogMessage("Error Load2. CaseLoadPosition2 not a rack conv and not pick station conveyor!", Color.Red);
                                Core.Environment.Scene.Pause();
                                return;
                            }
                            jobdata.CaseLoadPosition1.Release();
                        ...
                        case MultishuttleElevatorJobData.JobModes.Unload1:
                            if (jobdata.UnloadConveyor != null)
                                SetElevatorConveyorDirection(elevator, jobdata.UnloadConveyor.LocalPosition.X, elevator.LocalPosition.X, false);
                            else if (jobdata.UnloadFixPoint != null)
                                SetElevatorConveyorDirection(elevator, jobdata.UnloadFixPoint.LocalPosition.X, elevator.LocalPosition.X, false);
                            if (jobdata.JobType == RackConveyor.RackConveyorTypes.Infeed)
                            {
                                if (elevator.CurrentJobData.UnloadConveyor.Route.Loads.Count < 2)
                                {
                                    ...
                                    jobdata.JobMode = MultishuttleElevatorJobData.JobModes.WaitingUnload1;
                            }
                            else
                            {
                                ...
                                DropStationPoint outpoint = shuttlecar.Multishuttle.DropStationPoints[key];

                                if (outpoint.Attached == null)
                                {
                                    LogMessage("Error. No drop station attached at: " + jobdata.DestinationGroupSide + " level: " + jobdata.DestinationsLevel, Color.Red);
                                    Core.Environment.Scene.Pause();
                                    return;
                                }

                               
                                if (outpoint.Attached == null || outpoint.Attached.Parent == null)
                                {
                                    {
                                        LogMessage("Error. No drop station found at: " + jobdata.DestinationGroupSide + " level: " + jobdata.DestinationsLevel, Color.Red);
                                        Core.Environment.Scene.Pause();
                                        return;
                                    }
                                }
                                ...
                                if (jobdata.CaseLoadPosition1 != null)
                                {
                                    ...
                                    if (jobdata.CaseLoadPosition1.Destination.Substring(0,1) == "D") //Going to drop station
                                ...
                                if (jobdata.CaseLoadPosition2 != null)
                                {
                                    ...
                                    if (jobdata.CaseLoadPosition2.Destination.Substring(0, 1) == "D") //Going to drop station
                        ...
                        case MultishuttleElevatorJobData.JobModes.Unload2:
                            ...
                            if (jobdata.JobType == RackConveyor.RackConveyorTypes.Infeed)
                            {
                                if (elevator.CurrentJobData.UnloadConveyor.Route.Loads.Count < 2)
                                {
                                    ...
                                    jobdata.JobMode = MultishuttleElevatorJobData.JobModes.WaitingUnload2;
                            }
                            else
                            {
                                //Outfeed job
            ...
            private void ToteArrivedAtConvElevatorSecondPosition(ActionPoint sender, Load load, MultiShuttleElevator elevator)
            {
                ...
                {
                    load.Stop();
                    if (elevator.CurrentJobData.JobType == RackConveyor.RackConveyorTypes.Infeed)
                ...
                {
                    if (elevator.CurrentJobData.UnloadFixPoint != null)
                    {
                        //Tote going to drop station. 
                        load.Stop();
                    }
                    else if (elevator.CurrentJobData.UnloadConveyor.Route.Loads.Count > 1)
                    {
            ...
            {
                if (sender.Parent.Motor.Direction == Core.Motors.Motor.Directions.Forward)
                {
                    load.Stop();
                    if (!elevator.Location2.Active && elevator.NumberOfTotes == 1)
                        load.Release();
                }
                else
                {
            ...
            {
                if (sender.Parent.Motor.Direction == Core.Motors.Motor.Directions.Backward)
                {
                    load.Stop();
                    if (!elevator.Location1.Active && elevator.NumberOfTotes == 1)
                        load.Release();
                }
                else
                {
            ...
            private void StartSecondJob(MultiShuttleElevator elevator)
            {
                if (elevator.CurrentJobData.CaseLoadPosition1 == null)
                ...
                else
                {
                    ...
                    DropStationPoint outpoint = null;
                    if (convType == "D")
                    {
                        //Pick station to drop station move
                        elevatordata.JobType = RackConveyor.RackConveyorTypes.Outfeed;
                    ...
                    RackConveyor rackconv = null;
                    if (!elevator.ParentMultiShuttle.RackConveyors.ContainsKey(key) && elevatordata.JobType == RackConveyor.RackConveyorTypes.Infeed)
                    {
                    ...
                    if (elevatordata.JobType == RackConveyor.RackConveyorTypes.Infeed)
                    {
                        rackconv = elevator.ParentMultiShuttle.RackConveyors[key];

                        if (rackconv.RackConveyorType == RackConveyor.RackConveyorTypes.Outfeed)
                        {
                            string dest = "";
                    ...
                    elevator.CurrentJobData.UnloadFixPoint = outpoint;
            ...
            private void StartElevatorOutfeedAndSendArrival(MultiShuttleElevator elevator)
            {
                int casedatacount = 1;
                ...
                DropStationPoint outfeedpoint = elevator.ParentMultiShuttle.DropStationPoints[key];
                ...
                {
                    string level1 = elevator.CurrentJobData.CaseLoadPosition1.Case_Data.DestinationPosition.Substring(8, 2);
                    string level2 = elevator.CurrentJobData.CaseLoadPosition2.Case_Data.DestinationPosition.Substring(8, 2);
                ...
                elevator.CurrentJobData.UnloadFixPoint = outfeedpoint;
                ...
                if (casedatacount == 1 && elevator.CurrentJobData.CaseLoadPosition1 != null)
                {
                    //Update current position (one tote always on pos 2)
                    elevator.CurrentJobData.CaseLoadPosition1.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos2 + "  ";
                    body = MissionDataSet(elevator.CurrentJobData.CaseLoadPosition1);
                }
                else if (casedatacount == 1 && elevator.CurrentJobData.CaseLoadPosition2 != null)
                {
                    //Update current position (one tote always on pos 2)
                    elevator.CurrentJobData.CaseLoadPosition2.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos2 + "  ";
                    body = MissionDataSet(elevator.CurrentJobData.CaseLoadPosition2);
                }
                else if (casedatacount == 2)
                {
                    //Update current position
                    elevator.CurrentJobData.CaseLoadPosition1.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos1 + "  ";
                    elevator.CurrentJobData.CaseLoadPosition2.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos2 + "  ";
                    body = MissionDataSet2(elevator.CurrentJobData.CaseLoadPosition1, elevator.CurrentJobData.CaseLoadPosition2);
                }

                SendTelegram("02", body, casedatacount);

                //release totes on outfeed conv  TODO
                //CheckInfeedConveyors();
                //ReleaseLastLocation(elevator.CurrentJobData.CaseLoadPosition2);
            ...
            private void StartElevatorInfeedAndSendArrival(MultiShuttleElevator elevator)
            {
                int casedatacount = 1;
                if (elevator.CurrentJobData.CaseLoadPosition2 != null && elevator.CurrentJobData.CaseLoadPosition1 != null)
                    casedatacount = 2;
                ...
                //Create telegram body
                if (casedatacount == 1 && elevator.CurrentJobData.CaseLoadPosition2 != null)
                {
                    //Update current position (one tote always on pos 2)
                    elevator.CurrentJobData.CaseLoadPosition2.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos2 + "  ";
                    body = MissionDataSet(elevator.CurrentJobData.CaseLoadPosition2);
                }
                else if (casedatacount == 1 && elevator.CurrentJobData.CaseLoadPosition1 != null)
                {
                    //Update current position (one tote always on pos 2)
                    elevator.CurrentJobData.CaseLoadPosition1.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos2 + "  ";
                    body = MissionDataSet(elevator.CurrentJobData.CaseLoadPosition1);
                ...
                else if (casedatacount == 2)
                {
                    ...
                    elevator.CurrentJobData.CaseLoadPosition2.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos2 + "  ";
                    elevator.CurrentJobData.CaseLoadPosition1.Case_Data.CurrentPosition = "E" + elevator.ParentMultiShuttle.AisleNo + elevator.ElevatorName + pos1 + "  ";
                    body = MissionDataSet2(elevator.CurrentJobData.CaseLoadPosition2, elevator.CurrentJobData.CaseLoadPosition1);
                }

                SendTelegram("02", body, casedatacount);

                //release totes on infeed conv 
                CheckInfeedConveyors();
                ReleaseLastLocation(elevator.CurrentJobData.CaseLoadPosition2);
            ...
            private void ReleaseLastLocation(Case_Load caseload)
            {
                if (caseload == null)
                    return;

                if (caseload.LastLocation != null)
                {
                    caseload.LastLocation.Release();
                }
            }

            private void CheckInfeedConveyors()
            {
                foreach (DematicMultiShuttle multishuttle in multishuttles)
                {
                    foreach (InfeedPickStationConveyor c in multishuttle.PickStationConveyors)
                    {
                        if (c.Route.Loads.Count == 0)
                        {
                            c.RFT = true;
                        }
                    }
            ...
            void ToteArrivedAtConvElevatorEntryExit(ActionPoint sender, Load load, MultiShuttleElevator elevator)
            {
                if (elevator.CurrentJobData != null)
                {
                    if (!(elevator.CurrentJobData.JobMode == MultishuttleElevatorJobData.JobModes.Load1 || elevator.CurrentJobData.JobMode == MultishuttleElevatorJobData.JobModes.Load2))
                    {
                        //Elevator is unloading. Switch to UnloadConveyor (rack) or Drop station
                        if (elevator.CurrentJobData.UnloadConveyor != null)
                        {
                            //tote going to rack conveyor  
                            load.Switch(elevator.CurrentJobData.UnloadConveyor.Route);
                        }
                        else if (elevator.CurrentJobData.UnloadFixPoint != null)
                        {
                            //Tote going to drop station            
                            load.Switch(elevator.CurrentJobData.UnloadFixPoint.Attached.Route);
                        }
                    }
                }
            ...
            public void ToteArrivedAtConvElevatorEntry(ActionPoint sender, Load load, MultiShuttleElevator elevator)
            {
                //Same logic for entry and exit point
                ToteArrivedAtConvElevatorEntryExit(sender, load, elevator);
            }

            public void ToteArrivedAtConvElevatorExit(ActionPoint sender, Load load, MultiShuttleElevator elevator)
            {
                //Same logic for entry and exit point
                ToteArrivedAtConvElevatorEntryExit(sender, load, elevator);
            }

            public void ToteArrivedAtConvPickStationLocation1(ActionPoint sender, Load load, DematicMultiShuttle multishuttle)
            {
                //Entry point for Multishuttle controller.
                ...
                InfeedPickStationConveyor conv = sender.Parent.Parent as InfeedPickStationConveyor;

                Case_Load caseload2 = conv.Location2.ActiveLoad as Case_Load;

                conv.RFT = false;

                //Set RFT for last conv
                if (caseload1.LastLocation != null)
                    caseload1.LastLocation.RFT = true;      
                ...
                if (caseload2 != null && caseload2.Waiting)
                {
                    //A tote at location2 and waiting for this tote
                    load.Stop();
                    caseload2.WaitingTime = 0; //Stop waiting. This triggers Tote_PickStation2TimeOut
                    return;
                }
                if (conv.Route.Loads.Count == 2 && caseload2 == null)
                {
                    //A caseload should arrive after this on location 2 or is being moved on to the elevator...  
                    if (conv.Route.Loads.Last.Value.Distance < conv.Location2.Distance)
                    {
                        if (conv.Route.Loads.Last.Value.UserData is MultishuttleElevatorJobData)
                            return; //case is moving on to elevator. Let this one pass
                ...
                {                    
                    load.Stop();
                    //caseload2 has already sent 25 arrival telegram.
                    return;
                }

                //Caseload moves on to location 2
                conv.RFT = true;
                ReleaseLastLocation(caseload1);
            }

            public void ToteArrivedAtConvPickStationLocation2(ActionPoint sender, Load load, DematicMultiShuttle multishuttle)
            {
                if (load.UserData is MultishuttleElevatorJobData)
                {
                    return;
                    //caseload is moving on to elevator. Ignore.
                }
                ...
                if (!conv.Location1.Active)
                {
                    //No caseload on location 1. Wait...
                    load.WaitingTime = multishuttle.PickStation2Timeout; //Wait for tote nr 2
            ...
            void Tote_PickStation2TimeOut(Load load)
            {
                ...
                InfeedPickStationConveyor conv = load.CurrentActionPoint.Parent.Parent as InfeedPickStationConveyor;
                ...
                if (caseload1 != null)
                {
                    caseload1.Case_Data.CurrentPosition = location1;
                    caseload1.Case_Data.RoutingTableUpdateWait = true;
                ...
                caseload2.Case_Data.CurrentPosition = location2;
                caseload2.Case_Data.RoutingTableUpdateWait = true;

                //Pick station conveyor will not accept more totes
                conv.RFT = false;

                string Position2ULHeight = (caseload2.Height * 1000).ToString("0000"); 

                string body = PickStationDataSet(caseload2, caseload1, location2,
            ...
            public void ToteArrivedAtConvPickStationExit(ActionPoint sender, Load load)
            {
                InfeedPickStationConveyor conv = sender.Parent.Parent as InfeedPickStationConveyor;

                //Switch to elevator
                if (conv.Elevator.Direction == Core.Motors.Motor.Directions.Forward)
                    load.Switch(conv.Elevator.EntryPoint);
                else
                    load.Switch(conv.Elevator.ExitPoint);

                //Check Pick station queue. Release if empty
                if (conv.Route.Loads.Count == 0 && conv.Entry.Active)
                    conv.Entry.Release();
            }

            public void ToteArrivedAtConvPickStationEntry(ActionPoint sender, Load load)
            {
                InfeedPickStationConveyor conv = sender.Parent.Parent as InfeedPickStationConveyor;

                //Allow only 2 totes on Pick station
                if (conv.Route.Loads.Count >= 2)
                    load.Stop();
            }
            ...
            public void ToteArrivedAtRackConvLocation1(ActionPoint sender, Load load, DematicMultiShuttle multishuttle)
            {
                ...
                else
                {
                    ...
                    //Check if shuttle is waiting and location 2 is free
                    if (!conv.Location2.Active)
                    {
                        ...
                        if (shuttle.Control.CurrentJob == null && !shuttle.Control.Running && shuttle.Control.JobQueue.Count > 0 && shuttle.Control.ShuttleLocked)
                        {
                            ...
                            if (nextjob.JobType == ShuttleJob.JobTypes.Drop && !nextjob.Rack)
                            {
                                ...
                                if (!dropconv.Location2.Active)
                                     shuttle.Control.Start(unLockshuttle: true);
                            }
                        }
                    ...
                    if (load.UserData is MultishuttleElevatorJobData)
                    {
                        //Tote is moving on to elevator. ignore
                        return;
                    }
                    ...
                    //Update current position 
                    caseload.Case_Data.CurrentPosition = "O" + multishuttle.AisleNo + conv.RackName.Substring(0, 2) + multishuttle.POS1OUTFEED + conv.Level;
            ...
            public void ToteArrivedAtRackConvExit(ActionPoint sender, Load load)
            {
                RackConveyor conv = sender.Parent.Parent as RackConveyor;
                if (conv.RackConveyorType != RackConveyor.RackConveyorTypes.Outfeed)
                {
                    load.Stop();
                    Case_Load caseload = load as Case_Load;
                    LogMessage("Error. Rack conveyor should be outfeed. Caseload ULID: " + caseload.ULID, Color.Red);
                    Core.Environment.Scene.Pause();
                    return;
                }

                //Switch to elevator
                if (conv.LocalPosition.X > conv.Elevator.LocalPosition.X)
                {
                    load.Switch(conv.Elevator.EntryPoint);
                }
                else
            ...
            public void ToteArrivedAtConvDropStation(DropStationPoint dropStationPoint, MultiShuttleElevator elevator, Case_Load caseload, DematicMultiShuttle multishuttle)
            {
                if (elevator.CurrentJobData == null)
                {
                ...
                if (elevator.CurrentJobData.JobMode == MultishuttleElevatorJobData.JobModes.Unload1)
                {
                    ...
                    if (elevator.CurrentJobData.JobType != RackConveyor.RackConveyorTypes.Outfeed)
                    {
                        //Elevator started another job
                        return;
                    }
                ...
                {
                    if (elevator.Location1.Active)
                    {
                        //Still one tote on elevator. Release it.
                        elevator.Location1.Release();
                        //This tote is the first - update current position
                        caseload.Case_Data.CurrentPosition = "D" + multishuttle.AisleNo + dropStationPoint.DropPositionGroupSide + multishuttle.POS1OUTFEED + dropStationPoint.Level;         
                    }
                    else if (elevator.Location2.Active)
                    {
                        //Still one tote on elevator. Release it.
                        elevator.Location2.Release();
                        //This tote is the first - update current position
                    ...
                    else
                    {
                        if (elevator.NumberOfTotes != 0)
                        {
                            LogMessage("Error. Tote arrived at drop station location 2. Expected to unload 1 but Elevator is not empty!", Color.Red);
                            Core.Environment.Scene.Pause();
                            return;
                        }

                        //This tote is the last - update current position
                        caseload.Case_Data.CurrentPosition = "D" + multishuttle.AisleNo + dropStationPoint.DropPositionGroupSide + multishuttle.POS2OUTFEED + dropStationPoint.Level;         
        ...
        public class MultiShuttleControllerInfo : AssemblyInfo
        {
            ...
            public string PLCID = "";
            public MultiShuttleController.MSCSuppressStates SuppressState = MultiShuttleController.MSCSuppressStates.Never;
            public string SSCCBarcodePrefix = "";
        }   
}
