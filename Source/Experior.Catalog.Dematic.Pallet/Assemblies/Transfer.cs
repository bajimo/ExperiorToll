...
{
    public class PalletTransfer : BaseStraight
    {
        public PalletTransferInfo transferInfo;
        
        public PalletTransfer(PalletTransferInfo info) : base(info)
        {
            transferInfo = info;
        }
        ...
        [Browsable(false)]
        public override PalletConveyorType ConveyorType
        {
            get { return base.ConveyorType; }
            set { base.ConveyorType = value; }
        }

        [Browsable(false)]
        public override RollerConveyorWidth RollerConveyorWidth
        {
            get { return base.RollerConveyorWidth; }
            set { base.RollerConveyorWidth = value; }
        }

    }

    [Serializable]
    [XmlInclude(typeof(PalletTransferInfo))]
    public class PalletTransferInfo : BaseStraightInfo
    {
