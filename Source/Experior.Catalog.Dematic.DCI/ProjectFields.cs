...
namespace Experior.Catalog.Dematic.DCI
{
    public partial class ProjectFieldTools : Form
    {
        DCICaseLoad caseLoad = null;
        DCITray tray = null;
        DCIEuroPallet euroPallet = null;
        public ProjectFieldTools(DCICaseLoad CaseLoad)
        {
            InitializeComponent();
            caseLoad = CaseLoad;
        ...
        public ProjectFieldTools(DCITray trayLoad)
        {
            InitializeComponent();
            tray = trayLoad;
        ...
        public ProjectFieldTools(DCIEuroPallet PalletLoad)
        {
            InitializeComponent();
